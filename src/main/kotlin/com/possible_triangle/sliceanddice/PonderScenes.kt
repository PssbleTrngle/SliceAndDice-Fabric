...
object PonderScenes {
    ...
    fun register() {
        ...
        HELPER.forComponents(Content.SPRINKLER_BLOCK, Content.FERTILIZER_BUCKET)
            .addStoryBoard("sprinkler/intro") { scene, util ->
                ...
                val fluid = FluidStack(Fluids.WATER, FluidConstants.BUCKET * 30)
            ...
            FluidStack(Fluids.LAVA, FluidConstants.BUCKET * 50).also { fluid ->
            ...
            FluidStack(AllFluids.POTION.get(), FluidConstants.BUCKET * 100, CompoundTag()).also { fluid ->
